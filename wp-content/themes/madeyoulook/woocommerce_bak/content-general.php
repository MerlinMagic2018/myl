...
//echo "<pre>All Product Parent categories "; print_r($parent_product_cats); echo "</pre>";
    ...
    <?php
        ...
        if ( $productTerms && ! is_wp_error( $productTerms ) ) {
            echo '<p class="product-meta--list">See All ' . $hello . 's ';
            foreach ($productTerms as $productTerm) {
                //if ($productTerm === reset($productTerms)) {
                echo '<span class="tags"><a class="cc" href="' .  esc_url( get_term_link( $productTerm->term_id ) ) . $productTerm->slug . '" rel="tag">' . $productTerm->name . '</a></span> ';
